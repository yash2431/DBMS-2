...
VALUES
 ...
 CREATE OR ALTER PROC PR_EMPLOYEE_DATA
...
EXEC PR_EMPLOYEE_DATA 'JOHN',''
EXEC PR_EMPLOYEE_DATA '','BROWN'
...
CREATE OR ALTER PROC PR_SALARY_DATA
	@SALARY1 INT,
	@SALARY2 INT
AS
BEGIN
...
EXEC PR_SALARY_DATA 60000,70000

--5. Create a Procedure that will accepts a date and gives all the employees who all are hired on that date. 
CREATE OR ALTER PROC PR_DATE_DATA
	@HIREDATE DATETIME
AS
BEGIN
	SELECT * FROM Employee
